...
img = cv2.imread('/data2/zyz/S3DIS/area_3/pano/depth/camera_0ccf3c78ef354902b516c62ef8fb7cf1_lounge_2_frame_equirectangular_domain_depth.png')

# 设置视场角和观察角度
fov = 65       # 视场角，单位度
theta = 0     # 水平角（yaw），单位度
phi = -30        # 垂直角（pitch），单位度
